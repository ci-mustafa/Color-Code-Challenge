...
1. Log in to GitHub and locate [GitHub Repository Color Code Challange](https://github.com/ci-mustafa/Color-Code-Challenge)
2. At the top of the Repository(not the main navigation) locate "Settings" button on the menu.
3. Scroll down the Settings page until you locate "GitHub Pages".
4. Under "Source", click the dropdown menu "None" and select "Main" and click "Save".
5. The page will automatically refresh.
6. Scroll back to locate the now-published site [link](https://ci-mustafa.github.io/Color-Code-Challenge/) in the "GitHub Pages" section.
